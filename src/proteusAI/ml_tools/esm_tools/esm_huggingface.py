...
def retrieve_model_tokenizer(model: Union[torch.nn.Module, String]) -> Tuple[torch.nn.Module, torch.nn.Tokenizer]:
...
def esm_design(
    ...
    Args:
        ...
        vocabulary (esm.data.vocabulary): If None, vocabulary will be loaded.
    ...
    if model is None or vocabulary is None:
        model, vocabulary = esm.pretrained.esm_if1_gvp4_t16_142M_UR50()
    ...
    for i in range(num_samples):
        ...
        ll, _ = score_sequence_in_complex(
            model, vocabulary, coords_dict, target_chain, sampled_seq
