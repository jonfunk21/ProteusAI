...
python3 train_esm_regressor.py --model esm1v --epochs 10 --save_checkpoints
python3 train_esm_regressor.py --model esm2 --epochs 10 --save_checkpoints
python3 train_VAE.py --encoder OHE --epochs 10 --save_checkpoints
python3 train_VAE.py --encoder BLOSUM62 --epochs 10 --save_checkpoints
python3 train_VAE.py --encoder BLOSUM50 --epochs 10 --save_checkpoints