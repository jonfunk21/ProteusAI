...
python3 train_FFNN.py --encoder OHE --epochs 3000 --save_checkpoints            #<-- Running...
#python3 train_FFNN.py --encoder BLOSUM50 --epochs 3000 --save_checkpoints       #<-- Running...
#python3 train_FFNN.py --encoder BLOSUM62 --epochs 3000 --save_checkpoints       #<-- Running...
#python3 train_FFNN_VAE.py --encoder OHE --epochs 3000 --save_checkpoints        #<-- Running...
#python3 train_FFNN_VAE.py --encoder BLOSUM50 --epochs 3000 --save_checkpoints   #<-- Running...
#python3 train_FFNN_VAE.py --encoder BLOSUM62 --epochs 3000 --save_checkpoints   #<-- Running...