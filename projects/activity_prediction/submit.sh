...
python3 train_FFNN.py --encoder OHE --epochs 5000 --save_checkpoints            #<-- TODO: run
python3 train_FFNN.py --encoder BLOSUM50 --epochs 5000 --save_checkpoints       #<-- TODO: run
python3 train_FFNN.py --encoder BLOSUM62 --epochs 5000 --save_checkpoints       #<-- TODO: run
